...
public class PetStoreService {
	...
	public PetStore findPetStorebyID(Long petStoreId) {
		return petStoreDao.findById(petStoreId).orElseThrow(() -> new NoSuchElementException ("Pet store with ID= " + petStoreId));
	}
	...
	private Employee findOrCreateEmployee(Long petStoreId, Long employeeId) {		//find or create EE 
		Employee employee;
	 ...
	 private Employee findEmployeeById(Long employeeId) {
	        return employeeDao.findById(employeeId)
	                .orElseThrow(() -> new NoSuchElementException("Employee with employee ID:" + employeeId + " does not exist."));
		}
	@Transactional(readOnly = false)
